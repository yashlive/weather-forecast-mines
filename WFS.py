...
.sub-header {
    ...
    background:#fff; padding:0.3rem 0 .1rem 0; border-radius:.9rem;
}
.mine-card {
    background:#fff; border-radius:2rem; box-shadow: 0 2px 16px #e0e7ef51; padding:2.4rem 1.2rem 1.1rem 1.2rem; width:350px; margin:auto; text-align:center; margin-bottom:2.4rem;
}
.mine-card .mine-title {
    font-size:1.35rem; font-weight:700; color:#212123; margin-bottom:0.35rem;
}
.mine-card .big-temp {
    font-size:2.75rem; font-weight:900; color:#1B2733; margin-bottom:0.65rem;
}
.mine-status-low { font-size:1.1rem; color:#18b178; font-weight:600; margin-bottom: 0.9rem;}
...
.metric-tile {
    background:#fafbff; border-radius:.8rem; box-shadow:0 1px 4px #e0e7ef28; flex:1; padding:.6rem .1rem; margin:.16rem;
    font-weight:500; font-size:.98rem; color:#34495e;
}
.metric-tile span { font-weight:700; font-size:1.1rem; color:#071654;}
hr {margin:1.08rem 0 0.7rem 0; border-top:1px solid #ececec;}
</style>
